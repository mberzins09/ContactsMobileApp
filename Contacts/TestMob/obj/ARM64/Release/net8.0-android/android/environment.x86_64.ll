...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100670697, ; uint32_t jnienv_initialize_method_token (0x6001ce9)
	i32 100670696, ; uint32_t jnienv_registerjninatives_method_token (0x6001ce8)
...
@dso_cache = dso_local local_unnamed_addr global [510 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 744437606672295515, ; hash 0xa54c60f1f24e65b, from name: aot-TestMob.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TestMob.dll.so
		ptr null; void* handle (0x0)
	}, ; 19
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.67_name, ; name: libaot-System.Net.Mail.dll.so
		ptr null; void* handle (0x0)
	}, ; 138
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 8299452900351830761, ; hash 0x732d9470c38e6ae9, from name: TestMob
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TestMob.dll.so
		ptr null; void* handle (0x0)
	}, ; 209
	...
	%struct.DSOCacheEntry {
		i64 8827691259605876916, ; hash 0x7a82426df3a100b4, from name: libaot-TestMob.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TestMob.dll.so
		ptr null; void* handle (0x0)
	}, ; 238
	...
	%struct.DSOCacheEntry {
		i64 10964659427791779212, ; hash 0x982a4ba804aab58c, from name: aot-TestMob
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TestMob.dll.so
		ptr null; void* handle (0x0)
	}, ; 294
	...
	%struct.DSOCacheEntry {
		i64 15033118421613564739, ; hash 0xd0a05d8e3aa85343, from name: libaot-TestMob
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TestMob.dll.so
		ptr null; void* handle (0x0)
	}, ; 418
	...
	%struct.DSOCacheEntry {
		i64 17755814920968487243, ; hash 0xf6695398a5e8414b, from name: TestMob.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TestMob.dll.so
		ptr null; void* handle (0x0)
	}, ; 488
...
@.env.3 = private unnamed_addr constant [37 x i8] c"f45ed74b-8c26-4b69-aa8c-fcdcd83a6a8a\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [24 x i8] c"com.companyname.testmob\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [22 x i8] c"libaot-TestMob.dll.so\00", align 16
...
@.DSOCacheEntry.67_name = private unnamed_addr constant [30 x i8] c"libaot-System.Net.Mail.dll.so\00", align 16
