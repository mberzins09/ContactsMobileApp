...
@dso_cache = dso_local local_unnamed_addr global [510 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 633941011, ; hash 0x25c92c13, from name: TestMob
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 644512644, ; hash 0x266a7b84, from name: libaot-TestMob.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TestMob.dll.so
		ptr null; void* handle (0x0)
	}, ; 69
	...
	%struct.DSOCacheEntry {
		i64 1196334248, ; hash 0x474e9ca8, from name: aot-TestMob
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TestMob.dll.so
		ptr null; void* handle (0x0)
	}, ; 133
	...
	%struct.DSOCacheEntry {
		i64 2649888491, ; hash 0x9df216eb, from name: libaot-TestMob
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TestMob.dll.so
		ptr null; void* handle (0x0)
	}, ; 315
	...
	%struct.DSOCacheEntry {
		i64 4056858214, ; hash 0xf1cebe66, from name: aot-TestMob.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TestMob.dll.so
		ptr null; void* handle (0x0)
	}, ; 481
	...
	%struct.DSOCacheEntry {
		i64 4175949061, ; hash 0xf8e7ed05, from name: TestMob.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TestMob.dll.so
		ptr null; void* handle (0x0)
	}, ; 501
